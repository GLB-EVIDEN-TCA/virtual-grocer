...
resource deploymentScript 'Microsoft.Resources/deploymentScripts@2020-10-01' = {
  ...
  properties: {
    ...
    scriptContent: 'git clone ${repoUrl}; git checkout feature/template; az storage blob upload-batch -s virtual-grocer/content/product-images/. -d products/product-images'
  }
}
